...
postRouter.delete('/del', postController.deleteAllPosts)  
postRouter.get('/', postController.getAllPosts)
postRouter.get('/:id', postController.getPostByID)
postRouter.post('/', authMiddleware, schemaPosts, inputValidationMiddleware, postController.createPost)
postRouter.put('/:id', authMiddleware, schemaPosts, inputValidationMiddleware, postController.updatePost)
postRouter.delete('/:id', authMiddleware, postController.deletePostById)
postRouter.post('/:postId/comments',authMiddlewareWithJWT, commentInputModel, inputValidationMiddleware, postController.createCommentForPost) 
